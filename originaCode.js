(function() {
    ...
    const _document = document.querySelector("iframe").contentWindow.document;
    const winners = Array.from(_document.querySelectorAll('._54_6._4-ss._4-sv a[data-hovercard]')).reverse();
